$(function () {
    ...
    $("#end").attr({"value": dateend});
	 ypyqqs(datestart,dateend,ajbh);
	 ypyqts(datestart,dateend,ajbh);
//	 cbfxqgqs(datestart,dateend,ajbh);
//	 cbfxqgfb(datestart,dateend,ajbh);	 
...
// //     }
// //     return time_list[0] + "-" + time2 + "-" + time_list[2]
// // }


function ajaxMethod(ajbh){
	$.ajax({
		url:"",
		async : true, 
		data:"ajbh="+ajbh,
...
//态势分析舆情趋势
function ypyqqs(datestart,dateend,ajbh) {
...
//态势研判舆情态势
function ypyqts(datestart,dateend,ajbh) {
		...
		success : function(data) {
			...
			if (result) {
				...
				lineChart.setOption({        //加载数据图表
				    ...
				    legend:{
				    	data:['0：特重警情','1：重警情','2:中度警情','3:轻警情','4:无 '],
