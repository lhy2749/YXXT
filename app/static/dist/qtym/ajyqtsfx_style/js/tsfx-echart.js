$(function () {
    ...
    $("#end").attr({"value": dateend});
	 cbfxyqqs(ajbh,datestart,dateend);
	 cbfxmtfb(ajbh,datestart,dateend);	  
});
...
//态势分析舆情趋势
function cbfxyqqs(ajbh,datestart,dateend) {
...
//态势分析舆情态势
function cbfxmtfb(ajbh,datestart,dateend) {
