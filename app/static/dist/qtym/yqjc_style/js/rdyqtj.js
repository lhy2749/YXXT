//统计信息 舆情趋势
function yqqs(sjbh, datestart, dateend) {
...
//统计信息 媒体分布
function mtfb(sjbh, datestart, dateend) {
//	var sjbh = $('#sjbh').val();
//	var datestart = $('#start').val();
//	var dateend = $('#end').val();
    ...
    $.ajax({
        type: "post",
        async: false,
        url: "getRdMtfbAction",    //请求发送到mtfbServlet处
        data: {
            sjbh: sjbh,
            datestart: datestart,
            dateend: dateend
...
//统计信息 情感趋势
function qgqs(sjbh, datestart, dateend) {
//	var sjbh = $('#sjbh').val();
//	var datestart = $('#start').val();
//	var dateend = $('#end').val();
    ...
    $.ajax({
        type: "post",
        async: false,
        url: "getRdQgqsAction",    //请求发送到mtfbServlet处
        data: {
            sjbh: sjbh,
            datestart: datestart,
            dateend: dateend
...
//统计信息 情感分布
function qgfb(sjbh, datestart, dateend) {
//	var sjbh = $('#sjbh').val();
//	var datestart = $('#start').val();
//	var dateend = $('#end').val();
    ...
    $.ajax({
        type: "post",
        async: false,
        url: "getRdQgfbAction",    //请求发送到mtfbServlet处
        dataType: "json",        //返回数据形式为json
        data: {
            sjbh: sjbh,
            datestart: datestart,
...
function mymethon() {
    ...
    if (d1 > d2 || d1 > NowDate || d2 > NowDate) {
        ...
        var datestart = $('#start').val();
        var dateend = $('#end').val();
        yqqs(sjbh, datestart, dateend);
        mtfb(sjbh, datestart, dateend);
        qgqs(sjbh, datestart, dateend);
        qgfb(sjbh, datestart, dateend);
    }
}
...
//    var datestart = datetime(30);
//    var dateend = datetime(0);
